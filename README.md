...
* compute desired moment when given current body rate
* use gain parameter, moments of inertia and error
* see QuadControl::BodyRateControl

### Implement roll pitch control in C++
* proportional controller
* compute desired pitch and roll angle
* use desired global acceleration, current attitude, desired collective thrust
* use rotation matrix for calculation
* see QuadControl::RollPitchControl

### Implement altitude controller in C++
* PID controller
* compute the desired quad thrust
* use desired and current altitude/velocity/pose, vertical position/velocity, feed-forward vertical acceleration
* implement integrator to control nonidealities of mass
* see QuadControl::AltitudeControl

### Implement lateral position control in C++
* PD controller 
* compute desired horizontal acceleration
* use desired lateral position/velocity and current acceleration.
* see QuadControl::LateralPositionControl

### Implement yaw control in C++
* P controller
* compute yaw rate 
* use a desired and current yaw rate
* see QuadControl::YawControl

### Implement calculating the motor commands given commanded thrust and moments in C++
* calculate thrust for each props
* use desired collective thrust and rotation moment
* calc perpendicular distance to axes
* solving linear equations
* see QuadControl::GenerateMotorCommands
